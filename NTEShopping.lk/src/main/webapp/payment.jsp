            ...
            <div class="row gx-3">
                <div class="col-12">
                    <div class="d-flex flex-column">
                        ...
                        <input class="form-control mb-3" type="text" placeholder="Name" value="Barry Allen" name="pname">
                    </div>
                </div>
                <div class="col-12">
                    <div class="d-flex flex-column">
                ...
                <div class="col-12">
                    <div class="btn btn-primary mb-3">
                        <span class="ps-3" onclick="validate()">Check Out</span>
                        <span class="fas fa-arrow-right" onclick="validate()"></span>
                    </div>
                </div>
            </div>
        </div>
